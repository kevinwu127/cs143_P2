...
class BTLeafNode {
  public:
    ...
    static const int PAIR_SIZE = sizeof(RecordId) + sizeof(int);
    static const int MAX_PAIRS = 85;
...
class BTNonLeafNode {
  public:
    static const int PAIR_SIZE = sizeof(int) + sizeof(PageId);
    static const int MAX_PAIRS = 127;
